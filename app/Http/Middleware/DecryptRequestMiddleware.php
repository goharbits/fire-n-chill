...
class DecryptRequestMiddleware
{
    ...
    {
        // Assign the encryption key from the environment in the constructor
        $this->encryptionKey = config('app.encryption.key');
        $this->iv = config('app.encryption.iv');
    }
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $fieldsToDecrypt = ['CreditCardNumber', 'ExpMonth', 'ExpYear', 'CVV'];
