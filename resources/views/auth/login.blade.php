<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        @if ($errors->has('message') && $errors->has('error_code') && $errors->get('error_code')[0] == 403)
                    <div class="mb-4 p-3 form-message error">
                Your email is not verified. Please verify it <a
                    class="color-midnight text-decoration-underline fw-300 fs-16"
                    href="{{ route('resend.otp') }}">here</a>.
            </div>
        @else
