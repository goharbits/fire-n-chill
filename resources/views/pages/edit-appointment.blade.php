        ...
        <div class="session-booking-section overflow-hidden mgb-100">
            <div class="container">
                <div class="page-title text-center mgb-35">
                    <h1 class="fs-65 color-midnight fw-700 lh-13 text-uppercase ls-04-minus font-hornsea-fc mgb-15">{{ __('Update appointment') }}</h1>
                    <p class="fs-20 fw-300 lh-13 color-midnight">Pick date and time.</p>
                </div>
                @include('partials.response')
                <div class="booking-session-form">
                    <form id="update-appointment-form" action="{{ route('client.update.appointment') }}" method="POST" data-js-form>
                        @csrf
                        ...
                        <div class="frm-field-btn text-center pdt-20">
                            <button
                                ...
                                <span class="fs-20 color-white fw-600 text-uppercase">Update</span>
                            </button>
                        </div>
                    </form>
                </div>
